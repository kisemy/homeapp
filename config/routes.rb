...
Osb::Application.routes.draw do
  ...
  scope "(:locale)" do
   ...
   # resources :glentries do
      #collection do
       # get 'filter_glentries'
       # get 'bulk_actions'
       # post 'load_glenties_data'
       # get 'duplicate_glentries'
       # get 'undo_actions'
      #  get 'verify_glentries_name'
   ...
   # end
    ...
    #resources :invoice_line_glentries
    resources :invoices do
     # resources :invoice_line_glentries
      collection do
        get 'filter_invoices'
   ...
   #resources :recurring_profile_line_glentries
